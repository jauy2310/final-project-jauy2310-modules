...
#define WS2812_DMA_BUFFER_LEN               (WS2812_DUMMY_LED_BITS) + (WS2812_MAX_LEDS * WS2812_BITS_PER_LED) + (WS2812_RESET_LATCH_BITS)

// constants
#define PULSE_BIT_0                         32
#define PULSE_BIT_1                         64
